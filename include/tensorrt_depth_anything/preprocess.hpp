...
#ifndef TENSORRT_DEPTH_ANYTHING__PREPROCESS_HPP_
#define TENSORRT_DEPTH_ANYTHING__PREPROCESS_HPP_
...
/**
 * @brief Optimized preprocessing including resize, letterbox, nhwc2nchw, toFloat and normalization
 * with batching for DEPTH_ANYTHING on gpus
 * @param[out] dst processed image
 * @param[in] src image
 * @param[in] d_w width for output
 * @param[in] d_h height for output
 ...
 * normalization with batching for DEPTH_ANYTHING on gpus
 * @param[out] dst processed image
 * @param[in] src image
 * @param[in] d_w width for output
 * @param[in] d_h height for output
 ...
 * and normalization with batching for DEPTH_ANYTHING on gpus
 * @param[out] dst processed image
 * @param[in] src image
 * @param[in] d_w width for output
 * @param[in] d_h height for output
...
#endif  // TENSORRT_DEPTH_ANYTHING__PREPROCESS_HPP_
